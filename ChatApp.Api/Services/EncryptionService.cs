...
namespace ChatApp.Api.Services
{
    public class EncryptionService
    {
        ...
        {
            // Lấy khóa mã hóa tin nhắn từ appsettings.json
            ...
            if (string.IsNullOrEmpty(base64Key))
            {
                throw new ArgumentNullException(
                    ...
                    "Chưa cấu hình Key mã hóa trong appsettings.json!"
                );
            }
        ...
        // Mã hóa nội dung tin nhắn bằng AES-GCM
        ...
        // Giải mã nội dung tin nhắn từ ciphertext, nonce và tag
