...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // Kiểm tra token đã lưu để tự động đăng nhập khi mở app
  ...
  // Tải cấu hình, theme và profile trước khi vào dashboard
  Future<void> _prepareAndNavigate() async {
    if (mounted) {
      setState(() => _isPreparingData = true);
    }
  ...
  void dispose() {
    ...
    _forgotConfirmPassCtrl.dispose();
  ...
  // Gửi OTP cho bước đăng ký bằng email
  void _submitRegStep1() async {
    String? err = await _controller.checkEmailAndSendOTP(
  ...
  void _submitRegStep3() async {
    ...
    if (_controller.validateName(name) != null) {
      _showError(_controller.validateName(name)!);
      return;
    }

    if (_controller.validatePassword(pass) != null) {
      _showError(_controller.validatePassword(pass)!);
      return;
    }
  ...
  void _submitForgotStep1() async {
    String? err = await _controller.requestForgotPasswordOTP(
  ...
  void _submitForgotStep2() async {
    String? err = await _controller.verifyForgotOTP(
      _forgotOtpCtrl.text.trim(),
    );
  ...
  void _submitForgotStep3() async {
    ...
    if (finalErr != null) {
      ...
      _forgotConfirmPassCtrl.clear();
    }
  }

  // Tạo ô nhập liệu dùng chung cho login, register và forgot password
  ...
  // Tạo khu vực đăng nhập bằng tài khoản mạng xã hội
          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                ...
                child: TextButton(
                  onPressed: () =>
                      _controller.switchForm(AuthFormType.forgotPassword),
                  child: Text(
                    'Quên mật khẩu?',
                    style: TextStyle(
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              Text(
                _controller.registerStep == 1
                    ? 'Bước 1: Cung cấp Email'
                    : _controller.registerStep == 2
                  ...
                  child: Column(
                    children: [
                      ...
                      if (_controller.registerStep == 1) ...[
                        ...
                        FilledButton(
                          onPressed:
                              _controller.isLoading ? null : _submitRegStep1,
                          style: FilledButton.styleFrom(
                            padding: const EdgeInsets.symmetric(vertical: 20),
                      ...
                      if (_controller.registerStep == 2) ...[
                        ...
                        Text(
                          'Hết hạn sau: ${_controller.otpTimerDisplay}',
                          style: TextStyle(
                            color: _controller.otpTimeLeft <= 30
                                ? Colors.red
                        ...
                        const SizedBox(height: 24),
                        FilledButton(
                          onPressed: (_controller.otpTimeLeft > 0 &&
                      ...
                      // Form hoàn thiện thông tin đăng ký
                      if (_controller.registerStep == 3) ...[
                        _buildTextField(
                          controller: _regNameCtrl,
                          label: 'Tên hiển thị (Tên thật)',
                        ...
                        _buildTextField(
                          ...
                          isPassword: true,
                          isPasswordVisible:
                              _controller.isRegConfirmPassVisible,
                          onVisibilityToggle:
                              _controller.toggleRegConfirmPassVisibility,
                        ),
                        const SizedBox(height: 16),
                        FilledButton(
                          onPressed:
                              _controller.isLoading ? null : _submitRegStep3,
                          style: FilledButton.styleFrom(
                            padding: const EdgeInsets.symmetric(vertical: 20),
                            minimumSize: const Size.fromHeight(60),
                            shape: RoundedRectangleBorder(
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              Text(
                _controller.forgotStep == 1
                    ? 'Bước 1: Khai báo Email'
                    : _controller.forgotStep == 2
                        ? 'Bước 2: Xác minh Email'
              ...
              AnimatedSwitcher(
                ...
                child: KeyedSubtree(
                  ...
                  child: Column(
                    children: [
                      // Form nhập email để khôi phục mật khẩu
                      if (_controller.forgotStep == 1) ...[
                        ...
                        FilledButton(
                          onPressed:
                              _controller.isLoading ? null : _submitForgotStep1,
                          style: FilledButton.styleFrom(
                            padding: const EdgeInsets.symmetric(vertical: 20),
                            minimumSize: const Size.fromHeight(60),
                            shape: RoundedRectangleBorder(
                      ...
                      // Form nhập OTP quên mật khẩu
                      if (_controller.forgotStep == 2) ...[
                        Text(
                          'Mã 6 số đã được gửi tới:\n${_controller.forgotEmail}',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            color: textColor,
                            fontWeight: FontWeight.w500,
                        ...
                        Text(
                          'Hết hạn sau: ${_controller.forgotOtpTimerDisplay}',
                          style: TextStyle(
                            color: _controller.forgotOtpTimeLeft <= 30
                                ? Colors.red
                                : Theme.of(context).colorScheme.primary,
                            fontWeight: FontWeight.bold,
                            fontSize: 16,
                        ...
                        const SizedBox(height: 24),
                        FilledButton(
                          onPressed: (_controller.forgotOtpTimeLeft > 0 &&
                                  !_controller.isLoading)
                              ? _submitForgotStep2
                              : null,
                          style: FilledButton.styleFrom(
                      ...
                      if (_controller.forgotStep == 3) ...[
                        _buildTextField(
                          ...
                          icon: Icons.lock_outline,
                          isPassword: true,
                          isPasswordVisible: _controller.isForgotPassVisible,
                          onVisibilityToggle:
                              _controller.toggleForgotPassVisibility,
                        ),
                        _buildTextField(
                          controller: _forgotConfirmPassCtrl,
                          label: 'Xác nhận mật khẩu mới',
                          icon: Icons.lock_reset_outlined,
                          isPassword: true,
                          isPasswordVisible:
                              _controller.isForgotConfirmPassVisible,
                          onVisibilityToggle:
                              _controller.toggleForgotConfirmPassVisibility,
                        ),
                        const SizedBox(height: 16),
                        FilledButton(
                          onPressed:
                              _controller.isLoading ? null : _submitForgotStep3,
                          style: FilledButton.styleFrom(
                            padding: const EdgeInsets.symmetric(vertical: 20),
                            minimumSize: const Size.fromHeight(60),
                            shape: RoundedRectangleBorder(
  ...
  Widget build(BuildContext context) {
    // Hiển thị màn hình chờ khi đang kiểm tra token hoặc tải dữ liệu
